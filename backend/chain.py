...
about SAP Commerce Cloud (Hybris).
...
# local
llm_local = Ollama(model="qwen2:latest")

retriever = get_retriever()
# answer_chain = create_chain(llm_local, retriever)
answer_chain = create_chain(gemini_pro, retriever)